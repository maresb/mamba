...
namespace
{
    ...
    TEST_CASE("PackageFetcher::write_repodata_record preserves trusted lockfile dependencies")
    {
        ...
        pkg_info.version = "1.0";
        pkg_info.build_string = "h123456_0";
        pkg_info.filename = "lockdep-pkg-1.0-h123456_0.tar.bz2";
        ...
        const std::string pkg_basename = "lockdep-pkg-1.0-h123456_0";
        ...
        index_json["depends"] = nlohmann::json::array({ "original-dep >=1.0", "other-dep" });
        index_json["constrains"] = nlohmann::json::array({ "original-constraint" });
